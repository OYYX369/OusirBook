<template>
  <div class="login-container">
    <div style="color: #000000; font-size: 50px; font-weight: bold; position: absolute; text-align: center; top: 50px">欧sir图书</div>
    <div class="login-box"  >
...
.login-container {
  ...
  align-items: center;
  background-image: url("@/assets/imgs/1209085.jpeg");
