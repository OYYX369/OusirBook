<template>
  <div class="login-container">
    <div style="color: #39bf23; font-size: 50px; font-weight: bold; position: absolute; text-align: center; top: 50px">欧sir图书</div>
    <div class="login-box" style="background-image: linear-gradient(to right, #3ab5b0 0%, #3d99be 31%, #56317a 100%);">
...
.login-container {
  ...
  align-items: center;
  background-image: url("../assets/imgs/thumbbig-696114.webp");
